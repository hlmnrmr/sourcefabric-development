...
project = u'Development @ Sourcefabric'
copyright = u'%s, Sourcefabric' % datetime.datetime.now().year
...
latex_documents = [
  ('index', 'SourcefabricDev.tex', u'Development @ Sourcefabric',
   u'Holman Romero', 'manual'),
]
...
man_pages = [
    ('index', 'sourcefabricdev', u'Development @ Sourcefabric',
     [u'Holman Romero'], 1)
]
...
texinfo_documents = [
  ('index', 'Sourcefabric Development', u'Development @ Sourcefabric',
   u'Sourcefabric', 'Development', 'One line description of project.',
   'Miscellaneous'),
]
